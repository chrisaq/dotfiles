...
key_map("n", "<leader><space>", ":nohlsearch<CR>", { noremap = true, silent = true }) -- hide matches on <leader>space
key_map("n",  "<leader>v", '"+gP', { noremap = true, silent = true }) -- Paste from clipboard
key_map("n",  "<leader>q", ":q<CR>", { noremap = true, silent = true }) -- Quit window on <leader>q
key_map("n",  "<leader>Q", ":qall<CR>", { noremap = true, silent = true }) -- Quit all windows on <leader>Q
key_map("n", "<leader><BS>", [[:%s/\s\+$//<cr>:let @/=''<CR>]], { noremap = true, silent = true}) -- Remove trailing whitespace on <leader>backspace
